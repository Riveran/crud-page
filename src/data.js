export const data = [
  ...
  },
  {
    ...
    bigText:
      'Евгений Понасенков После капитального научного разбора и уничтожения пагубного мифа об отечественной» войне 1812 я чувствую в себе силы и уверенность покончить с главным мифом и ложью XX века: объявляю запуск проекта по подготовке и изданию всеобъемлющего исследования по истории Второй мировой войны: «Величайшая трагедия человечества: истоки, ход, последств Теперь все зависит только от вас – от каждого из вас: если вам нужна правда (а без нее будущее не построить), то надо участвовать. Нет ничего важнее Знания: в нынешней ситуации это наилучшая «оппозиция» мерзостям режимов в разных краях. Кто себя уважает – тот действует, а не ждет. Теперь все зависит только от вас – от каждого из вас: если вам нужна правда (а без нее будущее не построить), то надо участвовать. Нет ничего важнее Знания: в нынешней ситуации это наилучшая «оппозиция» мерзостям режимов в разных краях. Кто себя уважает – тот действует, а не ждет. '
  },
  {
    id: 3,
    count: 0,
  ...
  },
  {
    ...
    category: 'History',
    pictures: 'https://s00.yaplakal.com/pics/pics_original/0/5/9/12070950.jpg',
    bigText:
